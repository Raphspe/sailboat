...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 flex items-center justify-center ${mobileTab === 'lexicon' ? 'invisible lg:visible' : ''}`}
        onClick={() => {
          setSelectedEntry(null)
          setSelectedPartFromDiagram(null)
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 lg:hidden">
        <div className="flex mx-4 rounded-2xl overflow-hidden" style={{
          ...
          <button
            ...
            aria-label="Afficher le schéma"
            aria-current={mobileTab === 'diagram' ? 'page' : undefined}
          ...
          <button
            ...
            aria-current={mobileTab === 'lexicon' ? 'page' : undefined}
